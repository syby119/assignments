...
public:
	...
	void renderTriangle(int* screenX, int* screenY, float* screenZ, glm::vec3 normal);
	void scanTwoLine(Side* sides, int left, int right, int dy, glm::vec3 normal);
	void render(ScanLine scanLine, glm::vec3 normal);
